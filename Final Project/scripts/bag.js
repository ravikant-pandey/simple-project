const Convenience_Fee = 99; // always define all CAPITAL
let bagItemObject;
onLoad()
function onLoad() {
  loadBagItemsObject()
...
function displayBagSummary() {
  ...
  let totalMRP = 0;
  let totalDiscount = 0;
  bagItemObject.forEach(begItem=>{
    totalMRP += begItem.original_price;
    totalDiscount += begItem.original_price - begItem.current_price 
  })
